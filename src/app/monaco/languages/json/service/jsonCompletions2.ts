...
function getValueSuggestions(schema: JsonSchema.JSONSchema, doc: Parser.JSONDocument, node: Parser.ASTNode, offset: number, collector: ISuggestionsCollector): void {
...
function addDefaultSuggestion(schema: JsonSchema.JSONSchema, collector: ISuggestionsCollector): void {
    if (schema.default) {
        collector.add({
...
function addEnumSuggestion(schema: JsonSchema.JSONSchema, collector: ISuggestionsCollector): void {
...
function isType(schema: JsonSchema.JSONSchema, type: string) {
 ...
 *
 */
function getPropertySuggestions(schema: JsonSchema.JSONSchema, doc: Parser.JSONDocument, node: Parser.ASTNode, addValue: boolean, isLast: boolean, collector: ISuggestionsCollector): void {
    let matchingSchemas: Parser.IApplicableSchema[] = [];
    doc.validate(schema, matchingSchemas, node.start);
...
function getTextForProperty(key: string, propertySchema: JsonSchema.JSONSchema, addValue: boolean, isLast: boolean): string {
