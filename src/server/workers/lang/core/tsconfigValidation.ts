...
const compilerOptionsValidation: simpleValidator.ValidationInfo = {
    ...
    jsx: { type: types.string, validStringValues: ['preserve', 'react'] },
    ...
    module: { type: types.string, validStringValues: ['commonjs', 'amd', 'system', 'umd', 'es6', 'es2015'] },
    ...
    target: { type: types.string, validStringValues: ['es3', 'es5', 'es6', 'es2015', 'es2016', 'es2017', 'esnext'] },
